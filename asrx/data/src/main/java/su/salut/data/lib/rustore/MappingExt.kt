...
import su.salut.data.lib.rustore.ResponseCode.Companion.PAYMENT_RESULT_CLOSED_BY_USER
import su.salut.data.lib.rustore.ResponseCode.Companion.PAYMENT_RESULT_DECLINED_BY_SERVER
import su.salut.data.lib.rustore.ResponseCode.Companion.PAYMENT_RESULT_INVALID_INVOICE
import su.salut.data.lib.rustore.ResponseCode.Companion.PAYMENT_RESULT_INVALID_PAYMENT_STATE
import su.salut.data.lib.rustore.ResponseCode.Companion.PAYMENT_RESULT_INVALID_PURCHASE
import su.salut.data.lib.rustore.ResponseCode.Companion.PAYMENT_RESULT_INVOICE_RESULT
import su.salut.data.lib.rustore.ResponseCode.Companion.PAYMENT_RESULT_PURCHASE_RESULT
import su.salut.data.lib.rustore.ResponseCode.Companion.PAYMENT_RESULT_TIMEOUT
